        ...
        <div className="flex items-center space-x-8">
            <div className="flex flex-col space-y-1">
                ...
                >
                    ...
                    <span className="text-2xl font-bold mt-1">{t('menu.home')}</span>
                </Link>
                <Link
                    to="/today"
                    className="px-3 py-2 rounded-lg text-sm font-medium text-gray-700 hover:text-indigo-600 hover:bg-indigo-50 transition-colors duration-200 flex items-center space-x-1"
                >
                    ...
                    <span className="text-2xl font-bold mt-1">{t('menu.today')}</span>
                </Link>
                <Link
                    to="/my"
                    className="px-3 py-2 rounded-lg text-sm font-medium text-gray-700 hover:text-indigo-600 hover:bg-indigo-50 transition-colors duration-200 flex items-center space-x-1"
                >
                    ...
                    <span className="text-2xl font-bold mt-1">{t('menu.my')}</span>
                </Link>
                <Link
                    to="/create"
                    className="px-3 py-2 rounded-lg text-sm font-medium text-gray-700 hover:text-indigo-600 hover:bg-indigo-50 transition-colors duration-200 flex items-center space-x-1"
